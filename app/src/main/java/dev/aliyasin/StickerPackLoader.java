...
import static dev.aliyasin.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static dev.aliyasin.StickerContentProvider.AVOID_CACHE;
import static dev.aliyasin.StickerContentProvider.IMAGE_DATA_VERSION;
import static dev.aliyasin.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static dev.aliyasin.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
import static dev.aliyasin.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static dev.aliyasin.StickerContentProvider.PUBLISHER_EMAIL;
import static dev.aliyasin.StickerContentProvider.PUBLISHER_WEBSITE;
import static dev.aliyasin.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static dev.aliyasin.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static dev.aliyasin.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static dev.aliyasin.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static dev.aliyasin.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static dev.aliyasin.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
